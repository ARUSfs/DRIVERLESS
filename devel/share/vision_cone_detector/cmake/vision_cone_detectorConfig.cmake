...
if("TRUE" STREQUAL "TRUE")
  set(vision_cone_detector_SOURCE_PREFIX /home/jorge/Documentos/DRIVERLESS/src/perception/vision_cone_detector)
  set(vision_cone_detector_DEVEL_PREFIX /home/jorge/Documentos/DRIVERLESS/devel)
  ...
  set(vision_cone_detector_INSTALL_PREFIX /home/jorge/Documentos/DRIVERLESS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vision_cone_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jorge/Documentos/DRIVERLESS/src/perception/vision_cone_detector/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT vision_cone_detector_NUM_DUMMY_TARGETS)
      set(vision_cone_detector_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::vision_cone_detector::wrapped-linker-option${vision_cone_detector_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR vision_cone_detector_NUM_DUMMY_TARGETS "${vision_cone_detector_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::vision_cone_detector::wrapped-linker-option${vision_cone_detector_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND vision_cone_detector_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(vision_cone_detector_EXPORTED_TARGETS ${${vision_cone_detector_dep}_EXPORTED_TARGETS})
endforeach()
