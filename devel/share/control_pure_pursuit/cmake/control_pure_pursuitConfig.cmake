...
if("TRUE" STREQUAL "TRUE")
  set(control_pure_pursuit_SOURCE_PREFIX /home/jorge/Documentos/DRIVERLESS/src/control/control_pure_pursuit)
  set(control_pure_pursuit_DEVEL_PREFIX /home/jorge/Documentos/DRIVERLESS/devel)
  ...
  set(control_pure_pursuit_INSTALL_PREFIX /home/jorge/Documentos/DRIVERLESS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control_pure_pursuit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jorge/Documentos/DRIVERLESS/src/control/control_pure_pursuit/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT control_pure_pursuit_NUM_DUMMY_TARGETS)
      set(control_pure_pursuit_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::control_pure_pursuit::wrapped-linker-option${control_pure_pursuit_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR control_pure_pursuit_NUM_DUMMY_TARGETS "${control_pure_pursuit_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::control_pure_pursuit::wrapped-linker-option${control_pure_pursuit_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND control_pure_pursuit_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(control_pure_pursuit_EXPORTED_TARGETS ${${control_pure_pursuit_dep}_EXPORTED_TARGETS})
endforeach()
