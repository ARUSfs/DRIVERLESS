...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common_msgs-srv:<Spawn-request> is deprecated: use common_msgs-srv:Spawn-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs-srv:x-val is deprecated.  Use common_msgs-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs-srv:y-val is deprecated.  Use common_msgs-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs-srv:theta-val is deprecated.  Use common_msgs-srv:theta instead.")
  (theta m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs-srv:name-val is deprecated.  Use common_msgs-srv:name instead.")
  (name m))
...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common_msgs-srv:<Spawn-response> is deprecated: use common_msgs-srv:Spawn-response instead.")))
