...
class ConeDataset(Dataset):
    ...
    def __init__(self, start, num_images, dataset_images_path,
...
class Dataset_for_test(Dataset):
    ...
    Parameters:
        -images: Numpy array os images processed
        -target_image_size: Size of image to reduce all
    """
    def __init__(self, images: np.ndarray, target_image_size):
        self.images = images
        self.target_image_size = target_image_size
    ...
    def __getitem__(self, index):
        ...
        # Transpose if matrix is not correct
